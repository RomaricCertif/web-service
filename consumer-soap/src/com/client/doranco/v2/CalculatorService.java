 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://ws.com/", wsdlLocation = "http://localhost:8080/web-service-soap/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://ws.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/web-service-soap/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://ws.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.com/", "CalculatorPort"), Calculator.class, features);
    }
