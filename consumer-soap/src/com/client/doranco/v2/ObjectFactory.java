 ...
 * generated in the com.client.doranco.v2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _SumResponse_QNAME = new QName("http://ws.com/", "sumResponse");
    private final static QName _Sum_QNAME = new QName("http://ws.com/", "sum");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.client.doranco.v2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.com/", name = "sumResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.com/", name = "sum")
